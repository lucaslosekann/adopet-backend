...
AdoptionRouter.get(
    ...
    AuthMiddleware,
    OngMiddleware,
    RequestHandler(AdoptionController.getAdoptantRG),
);
AdoptionRouter.get(
    "/docs/proofResidence/:adoptionId",
    AuthMiddleware,
    OngMiddleware,
    RequestHandler(AdoptionController.getAdoptantProofResidence),
);
AdoptionRouter.get(
    "/submission/:adoptionId",
    AuthMiddleware,
    OngMiddleware,
    RequestHandler(AdoptionController.getSubmission),
);
